...
//
// import DI, { Services } from '../___to-move___/DI';
// import App from '../___to-move___/App';
//
// import routes, { RouteItem } from './Config/Routes';
// import {UserInterface} from "../___to-move___/models/User";
//
...
// AssetsInit(assets, config.assetsPrefix);
