  ...
  const modal = (
    <Modal isOpen={modalIsOpen} title="Are you sure?" onClose={closeModal} type={ModalType.DANGER}>
      <Prose>
        ...
        <hr />
        <p>
          This action is <strong>NOT</strong> reversible. We cannot recover your game after this. Are you really sure
          you want to reset this game and lose all progress?
        </p>
      </Prose>
      <ButtonRow>
        <form method="post" action={`${Environment.clientApiHostname}/profile/reset`}>
          <input type="hidden" name="token" value={token} />
          <DangerButton type="submit">Yes, Reset Game</DangerButton>
        </form>
