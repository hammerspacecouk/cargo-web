        ...
        <div className="t-doc__main">
          <div className="text--prose">
            ...
            <ul className="messages">
              ...
              <li className="messages__message messages__message--ok">
                Success message (ok)
              </li>
              <li className="messages__message messages__message--error">
                Error message (error)
              </li>
              <li className="messages__message messages__message--warning">
