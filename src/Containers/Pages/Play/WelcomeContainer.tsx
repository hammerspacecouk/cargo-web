                ...
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420.41 431.71">
                        ...
                        <g>
                            ...
                            <g>
                                <path fill={flagColour} d="M281.95 73.49a84.56 84.56 0 0 1-25.25-.25c-15.2-2.47-21.15-7.84-34.77-10.43-7.14-1.36-18.1-2.27-32.52 1.16q3.21-31.12 6.43-62.26a87.64 87.64 0 0 1 30.44-.66c14.22 2.28 20.31 7.1 35.64 9.56a97.57 97.57 0 0 0 26.43.58q-3.19 31.17-6.4 62.3z"/>
                                <path fill="#fff" d="M242.39 22.62l3.02 8.57 8.77 2.36-7.21 5.53.46 9.07-7.48-5.16-8.49 3.24 2.59-8.7-5.7-7.07 9.08-.23 4.96-7.61z"/>
                            </g>
                        ...
                        <path fill="url(#a)"
                              ...
                              transform="translate(-39.16 -55.95)"/>
                    </svg>
