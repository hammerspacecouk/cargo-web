  ...
  <AboutLayout title="Policies">
    <Prose>
      ...
      <p>
        ...
        services. There are no analytics platforms tracking you or sending data
        about you to other companies. When you're using this website, you're{" "}
        <strong>only</strong> using this website. TODO - What about payments?
        This site <strong>only</strong> uses two cookies. These are
      </p>
      <TableStriped>
        <thead>
          <tr>
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              That's all it does. You can delete it, and you'll just have to log
              in again.
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              ...
              message and put it in the cookie. Then the next page will display
              it.
            </td>
            <td>
              This cookie's data has no value once it is used, so it designed to
              remove itself as soon as you close the tab/browser.
            </td>
          </tr>
        </tbody>
      </TableStriped>
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              the game can become interactive faster, without having to contact
              the server for data first. It is only used by your browser and not
              sent back to us.
            </td>
            <td>
              After 28 days our game code will automatically delete this when it
              tries to use it, and then replace it with a new one. It will be
              removed entirely if you log out.
            </td>
          </tr>
        </tbody>
      </TableStriped>
      ...
      <p>
        ...
        help with trust, this application is coded in the open. You can view all
        of the code that makes up this game at:
      </p>
      <p>
        In fact, if you want to submit bug fixes and feature requests please do
        over there, as long as they adhere to the Contributing guidelines.
      </p>
      <h2>Legalese</h2>
      <p>
