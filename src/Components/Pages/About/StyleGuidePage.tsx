  ...
  return (
    <AboutLayout title="Style Guide">
      <div className="text--prose">
        <p>
          This is a collection of elements to demonstrate the overall design of
          the application.
        </p>
      ...
      <div className="text--prose">
        ...
        <MessageError>
          ...
          amet, consectetur adipiscing elit. Sed feugiat ligula id enim feugiat
          posuere. Vestibulum feugiat dui eget lorem dictum bibendum. In
          ultrices sed felis non accumsan. Cras vel accumsan lectus, vitae
          elementum velit. Nunc facilisis quam nec tincidunt suscipit. Nunc
          metus dolor, feugiat nec ante quis, consectetur egestas lacus. Nullam
          interdum nunc ut pellentesque malesuada. Vestibulum mattis ex at
          finibus mollis. Vivamus vitae rutrum nisl. Nam facilisis vitae velit
          id mollis. Nam congue ante et ultricies ultrices. Etiam lacinia dolor
          eu metus condimentum vehicula id quis purus. Praesent blandit ipsum
          non eros tempus interdum.
        </MessageError>
