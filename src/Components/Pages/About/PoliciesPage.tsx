...
import MessageOk from "../../Molecules/Messages/MessageOk/MessageOk";
  ...
  return (
    <AboutLayout title="Policies">
      <div className="text--prose">
        ...
        <h3>Security</h3>
        <p>
          We don't ask for a password, so we don't have to store your password.
          We rely on alternative means of authentication using your account on
          third party services, or an e-mail to your inbox.
        </p>
        <h3>Your data</h3>
        <p>
          It is necessary to have a piece of information unique to you in order
          to allow you to log in and keep playing the same game. We use your
          e-mail address. However we don't store the e-mail address itself. We
        ...
        <p>
          ...
          There is no personally identifying data in our system. We also do not
          store which third-party account you used to tell us your e-mail
          address. This means you can mix and match which services you login
          with, as long as they use the same e-mail address. We do not have any
          further access to those third party accounts and we cannot post as
          you.
        </p>
        <p>
        ...
        <table className="table table--striped">
          ...
          <tbody>
            <tr>
              ...
              <td>
                This cookie saves you having to log in every time you come back.
                That's all it does. You can delete it, and you'll just have to
                log in again.
              </td>
              <td>
                It lasts for three months since last use. Therefore if you don't
                visit for three months it will naturally disappear and you will
            ...
            <tr>
              ...
              <td>
                This cookie is a temporary cookie that one page uses to tell the
                next page what to do. For example, one page might generate a
                message and put it in the cookie. Then the next page will
                display it.
              </td>
              <td>
                This cookie's data has no value once it is used, so it designed
                to remove itself as soon as you close the tab/browser.
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <p>
          There are a couple of localStorage parameters too. These are bits of
        ...
        <table className="table table--striped">
          ...
          <tbody>
            <tr>
              ...
              <td>
                This a local cache of your current session data. This is so that
                the game can become interactive faster, without having to
                contact the server for data first. It is only used by your
                browser and not sent back to us.
              </td>
              <td>
                After 28 days our game code will automatically delete this when
                it tries to use it, and then replace it with a new one. It will
                be removed entirely if you log out.
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <p>
          ...
          do over there, as long as they adhere to the Contributing guidelines.
        </p>
        <h2>Legalese</h2>
        <p>
