    ...
    <AboutLayout title="Policies">
      <div className="text--prose">
        ...
        <p>
          ...
          that <em>Cookie Banner</em>. Hurrah.
        </p>
        <p>
          There are a couple of localStorage parameters too. These are bits of
          data stored on your computer and read by your browser. They are
          never sent back to the server. These are:
        </p>
        <table className="table table--striped">
          <thead>
          <tr>
          ...
          <tr>
            ...
            <td>
              This a local cache of your current session data. This is so
              that the game can become interactive faster, without having to
              contact the server for data first. It is only used by your
              browser and not sent back to us.
            </td>
            <td>
              After 28 days our game code will automatically delete this
              when it tries to use it, and then replace it with a new one.
              It will be removed entirely if you log out.
            </td>
          </tr>
          </tbody>
        </table>
