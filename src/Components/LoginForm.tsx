    ...
    <div className="login-form">
      ...
      <ul className="login-form__social-list">
        <li>
          ...
          >
            <svg
              className="login-form__social-logo login-form__social-logo--facebook"
        ...
        <li>
          ...
          >
            <svg
              className="login-form__social-logo login-form__social-logo--google"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          ...
          >
            <svg
              className="login-form__social-logo login-form__social-logo--microsoft"
              viewBox="0 0 220 220"
            >
        ...
        <li>
          ...
          >
            <svg
              className="login-form__social-logo login-form__social-logo--twitter"
              xmlns="http://www.w3.org/2000/svg"
