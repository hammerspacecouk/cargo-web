...
import ShipInterface, {PLAY_PATH_SHOW, PLAY_PATH_EDIT} from "../../DomainInterfaces/ShipInterface";
        ...
        <div className={`menu ${props.isOpen ? 'menu--open' : ''}`}>
            ...
            <ul className="menu__ships">
                {props.playerShips.map((ship: ShipInterface, i: number) => (
                    <li className="menu__ship" key={i}>
                        <Link className="menu__ship-link"
                              onClick={props.linkClicked}
                              to={PLAY_PATH_SHOW(ship.id)}>{ship.name}</Link>
                        <Link className="menu__ship-edit"
                              onClick={props.linkClicked}
            ...
            <div className="menu__footer">
                <Link to="/"
                      ...
                      onClick={props.linkClicked}>
                    <span className="menu__footer-icon"><HomeIcon /></span>
                    <span className="menu__footer-text">Home</span>
                </Link>
                <Link to="/profile"
                      className="menu__footer-link"
                      onClick={props.linkClicked}>
                    <span className="menu__footer-icon"><ProfileIcon /></span>
