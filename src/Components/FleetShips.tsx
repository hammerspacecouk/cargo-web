...
const tempIcon = (
  <svg viewBox="0 0 469.33 469.33">
    <circle cx="234.67" cy="234.67" r="234.67" fill="#000000"></circle>
    <g>
      <path
    ...
    <path
      ...
      transform="translate(-15 -14.33)" fill="#fafafa"></path>
  </svg>
);
  ...
  <tr key={ship.id} className="m-fleet-ship">
    ...
    <td className="m-fleet-ship__cell m-fleet-ship__cell--name">
      <Link to={PLAY_PATH_SHOW(ship.id)} className="m-fleet-ship__meta">
        <div className="m-fleet-ship__name">
          {ship.name}
        </div>
        <div className="m-fleet-ship__class">
          {ship.shipClass.name}
        </div>
      </Link>
    </td>
    ...
    <td className="m-fleet-ship__cell m-fleet-ship__cell--capacity c">
      ...
      title={`This ship can carry ${ship.shipClass.capacity} crates`}>{ship.shipClass.capacity}</sub>
    </td>
