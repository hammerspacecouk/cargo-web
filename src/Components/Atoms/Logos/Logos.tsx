...
export const FacebookLogo = () => (
  ...
  >
    <path
      ...
      3.353h29.086v-23.52h-7.914v-9.166h7.914v-6.76c0-7.843 4.79-12.116
      11.787-12.116 3.355 0 6.232.253 7.07.36v8.2h-4.853c-3.805 0-4.54 1.81-4.54
      4.464v5.85h9.08l-1.188 9.167h-7.892v23.52h15.475c1.852 0 3.355-1.502
      3.355-3.35V3.35C60.732 1.5 59.23 0 57.378 0z"
    />
  </svg>
);
